...
import { bookJoiSchema, ReaderDtoJoiSchema } from "../utils/joiSchemas.js";
...
bookRouter.patch('/pick', bodyValidator(ReaderDtoJoiSchema), bookController.pickBook); //(req, res) => {bookController.addBook(req,res)}
